...
def test_parse_good_static():
    ...
    positive_result: structs.TagsGroup = parse_meta_tags_from_source(
        """
        <!DOCTYPE html>
        <html lang="en">
        <head>
    ...
    _image_wannabe_tag: structs.OneMetaTag = structs.OneMetaTag(
        name="image",
    ...
    assert _image_wannabe_tag in positive_result.open_graph

    assert _image_wannabe_tag in positive_result.twitter
